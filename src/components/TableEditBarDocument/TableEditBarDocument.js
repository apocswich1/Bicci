...
const TableEditBarDocument = props => {
  const {
    selected,
    className,
    onMarkPaid,
  ...
  const handleDelete = ()=>{
    ...
    console.log(params);
    fetch(service+'documentDeleteAdmin', {
        method: 'post',
        mode: 'cors',
  ...
  const handleStatus = (status)=>{
    ...
    console.log(params);
    fetch(service+'documentStatusAdmin', {
        method: 'post',
        mode: 'cors',
        body: JSON.stringify(params)
      }).then(function (respuesta) {
...
TableEditBarDocument.propTypes = {
...
export default TableEditBarDocument;
