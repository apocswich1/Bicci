...
const TableEditBarRestaurant = props => {
  const {
    selected,
    className,
    onMarkPaid,
  ...
  const handleDelete = ()=>{
    ...
    console.log(params);
    fetch(service+'placeDeleteAdmin', {
        method: 'post',
        mode: 'cors',
  ...
  const handleStatus = (status)=>{
    ...
    console.log(params);
    fetch(service+'placeStatusAdmin', {
        method: 'post',
        mode: 'cors',
        body: JSON.stringify(params)
      }).then(function (respuesta) {
...
TableEditBarRestaurant.propTypes = {
...
export default TableEditBarRestaurant;
