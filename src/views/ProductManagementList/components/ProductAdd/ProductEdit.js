...
const ProductEdit = props => {
  const { open, onClose, product, className, ...rest } = props;
            ...
            >
              ...
              >
                ...
                <Typography variant="body2">
                  Disabling this will automatically send the product a verification
                  email
                </Typography>
                <Switch
              ...
              >
                ...
                <Typography variant="body2">
                  This will give the product discountedprices for all products
                </Typography>
                <Switch
