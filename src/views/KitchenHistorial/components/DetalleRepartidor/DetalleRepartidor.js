      ...
      <div className={classes.statsContainer}>
        <div className={classes.statsItem1}>
          <Typography align="left" variant="h1">
            {orden.driverName} ( {orden.driverPhone} )<br /><br />
            {orden.id}
          </Typography>
        </div>
        <div className={classes.statsItem2}>
          ...
          <img
            alt="Logo"
            src={orden.driverAvatar ? orden.driverAvatar : '/images/avatars/avatar_1.png'}
            height="120px"
