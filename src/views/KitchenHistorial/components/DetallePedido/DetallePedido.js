...
const DetallePedido = props => {
  ...
  const { orden, valuePestana, setOpenDetalle, ordenes, setOrden, grocery,fetchData } = props;
    ...
    <div className={classes.root}>
      <AppBar position="static" color="default">
        ...
        >
          ...
          {(orden.length) < 1 || (orden.driverID == undefined) ? (
            <Tab label="Bicci Driver" {...a11yProps(1)} disabled/>
          ) : (
            <Tab label="Bicci Driver" {...a11yProps(1)} />
          )}
        </Tabs>
      </AppBar>
      <SwipeableViews
      ...
      >
        <TabPanel value={value} index={0} dir={theme.direction}>
          ...
          <DetalleOrden setOpenDetalle={setOpenDetalle} orden={orden} grocery={grocery} fetchData={fetchData}/>
          </Paper>
        </TabPanel>
