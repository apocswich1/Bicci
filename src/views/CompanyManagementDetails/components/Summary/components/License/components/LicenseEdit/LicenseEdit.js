...
const LicenseEdit = props => {
  ...
  const handleSave = () => {
    ...
    let msg = "Licencia actualizada exitosamente!";
    ...
    if(isValid){
     ...
     var uploadDoc = storageRef.child(`/driverLicence/${driver.id}/${driver.id}.jpg`).put(filess[0]);
...
LicenseEdit.displayName = 'LicenseEdit';

LicenseEdit.propTypes = {
