...
const DocumentEdit = props => {
  const { open, onClose, document, className, ...rest } = props;
            ...
            >
              ...
              >
                ...
                <Typography variant="body2">
                  Disabling this will automatically send the document a verification
                  email
                </Typography>
                <Switch
              ...
              >
                ...
                <Typography variant="body2">
                  This will give the document discountedprices for all documents
                </Typography>
                <Switch
