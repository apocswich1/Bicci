...
const PromotionManagementDetails = props => {
  ...
  if (!tab) {
    return <Redirect to={"/management/promotions/"+id+"/summary"} />;
  }
  ...
  return (
    <Page
      ...
      title="Promotion Management Details"
    >
      <Header id={id}/>
      <Tabs
...
PromotionManagementDetails.propTypes = {
