...
const KitchenEditPrice = props => {
  const { open, onClose, kitchen, actualizar, className, cboCategories, ...rest } = props;
...
KitchenEditPrice.displayName = 'KitchenEditPrice';

KitchenEditPrice.propTypes = {
...
KitchenEditPrice.defaultProps = {
  open: false,
  onClose: () => {}
};

export default KitchenEditPrice;
