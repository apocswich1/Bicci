...
const SubstanceAdd = props => {
  const { open, onClose, substance, actualizar, setLoading, className, ...rest } = props;
  ...
  const handleSave = (event) => {
    ...
    let msg = "Substances creado con exito";
    ...
    if(isValid){
      ...
      fetch(service+'createSubstancesAdmin', {
          method: 'post',
          mode: 'cors',
...
SubstanceAdd.displayName = 'SubstanceAdd';

SubstanceAdd.propTypes = {
...
SubstanceAdd.defaultProps = {
  open: false,
  onClose: () => { }
};

export default SubstanceAdd;
