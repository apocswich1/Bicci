...
const SubstanceEdit = props => {
  const { open, onClose, substance, className, ...rest } = props;
            ...
            >
              ...
              >
                ...
                <Typography variant="body2">
                  Disabling this will automatically send the substance a verification
                  email
                </Typography>
                <Switch
              ...
              >
                ...
                <Typography variant="body2">
                  This will give the substance discountedprices for all substances
                </Typography>
                <Switch
