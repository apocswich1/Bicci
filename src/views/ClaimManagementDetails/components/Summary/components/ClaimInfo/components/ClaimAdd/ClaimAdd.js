...
const ClaimAdd = props => {
  const { open, onClose, claim, actualizar, setLoading, className, ...rest } = props;
  ...
  const handleSave = (event) => {
    ...
    let msg = "Claims creado con exito";
    ...
    if(isValid){
      ...
      fetch(service+'createClaimsAdmin', {
          method: 'post',
          mode: 'cors',
            ...
            console.log(body);
             ...
             uploadDoc.on('state_changed', function (snapshot) {
               ...
               uploadDoc.snapshot.ref.getDownloadURL().then(function (downloadURL) {
                 ...
                 console.log(data);
                const refWasher = firebase.firestore().collection('claims').doc(body.id);
