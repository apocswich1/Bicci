...
const AvatarEdit = props => {
  ...
  const handleSave = () => {
    ...
    let msg = "Avatar actualizado exitosamente!";
    ...
    if(isValid){
     ...
     var uploadDoc = storageRef.child(`/thumbnails/${administrator.id}/${administrator.id}.jpg`).put(filess[0]);
