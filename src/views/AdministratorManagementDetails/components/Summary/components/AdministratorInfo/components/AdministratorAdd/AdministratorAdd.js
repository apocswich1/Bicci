...
const AdministratorAdd = props => {
  const { open, onClose, administrator, actualizar, setLoading, className, ...rest } = props;
  ...
  const handleSave = (event) => {
    ...
    if(isValid){
      ...
      fetch(service+'createAdministratorsAdmin', {
          method: 'post',
          mode: 'cors',
...
AdministratorAdd.displayName = 'AdministratorAdd';

AdministratorAdd.propTypes = {
