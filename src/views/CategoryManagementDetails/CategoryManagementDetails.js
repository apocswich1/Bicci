...
const CategoryManagementDetails = props => {
  ...
  if (!tab) {
    return <Redirect to={`/management/categories/${id}/summary`} />;
  }
  ...
  return (
    <Page
      ...
      title="Category Management Details"
    >
      <Header id={id}/>
      <Tabs
...
CategoryManagementDetails.propTypes = {
