...
import { StoreEdit } from './components';
...
const StoreInfo = props => {
  const { store, className, actualizar, ...rest } = props;
        ...
        <Table>
          ...
          <TableRow>
            ...
            <TableRow>
              ...
              <TableCell>{new String(store.deleted != undefined ? store.deleted : false)}</TableCell>
            </TableRow>
          </TableBody>
        </Table>
      </CardContent>
