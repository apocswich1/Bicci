...
const CategoryEdit = props => {
  const { open, onClose, category, className, ...rest } = props;
            ...
            >
              ...
              >
                ...
                <Typography variant="body2">
                  Disabling this will automatically send the category a verification
                  email
                </Typography>
                <Switch
              ...
              >
                ...
                <Typography variant="body2">
                  This will give the category discountedprices for all categorys
                </Typography>
                <Switch
