...
const translate = (word) => {
    ...
    switch (word.toLowerCase()) {
        ...
        case 'role': return (lang == 'es') ? 'Perfil' : 'role'; break;
        ...
        case 'categories': return (lang == 'es') ? 'Categorias' : 'Categories'; break;
        case 'category': return (lang == 'es') ? 'Categoría' : 'Category'; break;
        case 'categories list': return (lang == 'es') ? 'Lista de categorias' : 'Categories list'; break;
        case 'category info': return (lang == 'es') ? 'Información de categoria' : 'Category info'; break;
        case 'documents': return (lang == 'es') ? 'Documentos' : 'Documents'; break;
        case 'document': return (lang == 'es') ? 'Documento' : 'Document'; break;
        case 'documents list': return (lang == 'es') ? 'Lista de documentos' : 'Documents list'; break;
        case 'stores': return (lang == 'es') ? 'Tiendas' : 'Stores'; break;
        case 'stores list': return (lang == 'es') ? 'Lista de tiendas' : 'Stores list'; break;
        case 'store info': return (lang == 'es') ? 'Información de tienda' : 'Store info'; break;
        ...
        case 'product': return (lang == 'es') ? 'Producto' : 'Product'; break;
        case 'products': return (lang == 'es') ? 'Productos' : 'Products'; break;
        case 'store': return (lang == 'es') ? 'Tienda' : 'Store'; break;
        case 'document': return (lang == 'es') ? 'Documento' : 'Document'; break;
        case 'documents': return (lang == 'es') ? 'Documentos' : 'Documents'; break;
        case 'substance': return (lang == 'es') ? 'Sustancia' : 'Substance'; break;
        case 'substances': return (lang == 'es') ? 'Sustancias' : 'Substances'; break;
        case 'driver': return (lang == 'es') ? 'Conductor' : 'Driver'; break;
        case 'drivers': return (lang == 'es') ? 'Conductores' : 'Drivers'; break;
        case 'substance info': return (lang == 'es') ? 'Información de sustancia' : 'Substance info'; break;
        ...
        case 'sign in': return (lang == 'es') ? 'Iniciar Sesión' : 'Sign in'; break;
        ...
        case 'repeat password': return (lang == 'es') ? 'Repetir Contraseña' : 'Repeat Password'; break;
        case 'disable': return (lang == 'es') ? 'Deshabilitar' : 'Disable'; break;
        case 'enable': return (lang == 'es') ? 'habilitar' : 'Enable'; break;
        case 'login as': return (lang == 'es') ? 'Loguear como' : 'Login as'; break;
        case 'export client': return (lang == 'es') ? 'Exportar Datos' : 'Export Client Data'; break;
        case 'export client data': return (lang == 'es') ? 'Exportar Datos del Cliente' : 'Export Client Data'; break;
